...
import { ChevronDown, ChevronUp, Eye, Grid, Plus, Save, Trash2, Upload, List } from "lucide-react"
                ...
                <div className="grid gap-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="category-description-1" defaultValue="Start your meal with these delicious options" />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <div className="aspect-[3/1] bg-gray-100 rounded-lg relative overflow-hidden">
                      <Image src="/placeholder.svg?height=200&width=600" alt="Cover" fill className="object-cover" />
                    </div>
